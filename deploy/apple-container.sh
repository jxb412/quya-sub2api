...
prepare_environment() {
    ...
    APP_IMAGE="$(read_env_value APPLE_CONTAINER_SUB2API_IMAGE ghcr.io/jxb412/sub2api:latest)"
...
SETUP_ENABLED=${SETUP_ENABLED:-false}
AUTO_SETUP=${AUTO_SETUP:-false}
DATABASE_INITIALIZATION_ENABLED=${DATABASE_INITIALIZATION_ENABLED:-false}
SERVER_HOST=0.0.0.0
SERVER_PORT=8080
