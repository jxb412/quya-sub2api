...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/jxb412/quya-sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/jxb412/quya-sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/jxb412/quya-sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/jxb412/quya-sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
